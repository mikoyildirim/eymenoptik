    ...
    private function valid(Request $r, bool $isUpdate = false)
    {
        ...
        return $r->validate([
            ...
            'glass_color' => $isLensCategory
                ...
                : 'nullable|in:siyah,beyaz,kahverengi,fume,fume_degrade,saydam,altin,gumus,kirmizi,mavi,yesil,pembe,mor,sari,kahverengi_degrade,bordo,turuncu,mavi_degrade,mavi_aynali,silver_mirror,karisik',
