...
@section('title', $category->exists ? 'Kategori Düzenle' : 'Kategori Ekle')
...
<div class="eo-page-header">
    <div>
        ...
        <h1>{{ $category->exists ? 'Kategori Düzenle' : 'Yeni Kategori Ekle' }}</h1>

        <p>Ürünleri doğru gruplamak için kategori bilgilerini yönetin.</p>
    </div>

    <a href="{{ route('admin.categories.index') }}" class="btn eo-btn-light">
            ...
            <div class="card eo-card">
                <div class="card-header eo-card-header">
                    <div>
                        ...
                        <p>Kategori adı ve mağaza görünürlüğü</p>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <label class="eo-check">
                        ...
                        <span>
                            <b>Aktif Kategori</b>
                            <small>Kategori mağaza ve admin listelerinde aktif görünsün.</small>
                        </span>
                    </label>
            ...
            <div class="card eo-card">
                <div class="card-header eo-card-header">
                    <div>
                        ...
                        <p>Kategorinin panel görünümü</p>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="eo-preview-card">
                        ...
                        <div>
                            <h4>{{ old('name', $category->name) ?: 'Kategori Adı' }}</h4>
                            <span>{{ $category->exists ? 'Mevcut kategori' : 'Yeni kategori' }}</span>
                        </div>
                    </div>
