...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .status.green { background: rgba(22,163,107,.12); color: var(--green); }
        .status.gold { background: rgba(199,154,58,.14); color: #9b741d; }
        .status.blue { background: rgba(40,84,217,.12); color: var(--blue); }
        ...
        .cart-item span { color: var(--muted); font-size: 13px; font-weight: 850; }
        ...
        @media (max-width: 1120px) {
            ...
            .dashboard-grid, .welcome, .content-grid { grid-template-columns: 1fr; }
        ...
        @media (max-width: 680px) {
            ...
            .welcome { padding: 23px; border-radius: 30px; }
            .welcome h1 { letter-spacing: -2px; }
            .side-menu, .stats-grid, .category-row, .product-grid { grid-template-columns: 1fr; }
            .panel { border-radius: 28px; padding: 18px; }
            .order-item { grid-template-columns: auto 1fr; }
            .order-item .status { grid-column: 1 / -1; width: max-content; }
        ...
        <div class="container dashboard-grid">
            ...
            <section>
                ...
                <div class="stats-grid reveal">
                    <div class="stat-card"><div class="stat-icon">📦</div><b>3</b><span>Aktif sipariş</span></div>
                    <div class="stat-card"><div class="stat-icon">♡</div><b>3</b><span>Favori ürün</span></div>
                    <div class="stat-card"><div class="stat-icon">🎁</div><b>1</b><span>Aktif kupon</span></div>
                    <div class="stat-card"><div class="stat-icon">🛒</div><b id="miniCartCount">0</b><span>Sepette ürün</span></div>
                </div>
                ...
                <div class="category-row reveal">
                    <a href="#products" class="category-card"><div class="cat-icon">🕶️</div><b>Güneş Gözlüğü</b><span>64 ürün</span></a>
                    <a href="#products" class="category-card"><div class="cat-icon">👓</div><b>Optik Çerçeve</b><span>48 ürün</span></a>
                    <a href="#products" class="category-card"><div class="cat-icon">✨</div><b>Luxury Seri</b><span>22 ürün</span></a>
                    <a href="#products" class="category-card"><div class="cat-icon">🏃</div><b>Spor</b><span>36 ürün</span></a>
                    <a href="#products" class="category-card"><div class="cat-icon">🧒</div><b>Çocuk</b><span>18 ürün</span></a>
                </div>
