...
<section class="legal-page">
    <div class="container">
        <div class="legal-card">
            ...
            <h1>SSL Sertifikası</h1>
            <p>Web sitemizde kullanıcı güvenliğini korumak için SSL sertifikası kullanılmaktadır. SSL, tarayıcı ile web sitesi arasındaki veri aktarımını şifreleyerek kişisel bilgilerinizin korunmasına yardımcı olur.</p>
<h2>Güvenli Alışveriş</h2><p>Üyelik, sipariş ve ödeme süreçlerinde paylaştığınız bilgiler güvenli bağlantı üzerinden iletilir.</p>
        </div>
    </div>
</section>
@endsection
